...
function displayOrders(req, res) {
  ...
  const displayOrdersStr = 'SELECT oi.fk_orders, oi.fk_menu_item, mi.menu_item_name, o.order_ready, r.rest_name, u.user_firstname, u.user_lastname FROM order_items AS oi INNER JOIN orders as o ON oi.fk_orders = o.order_id  INNER JOIN menu_items as mi ON oi.fk_menu_item = mi.menu_item_id INNER JOIN restaurants as r ON o.fk_rest_id = r.rest_id INNER JOIN users as u ON o.fk_user_id = u.user_id WHERE r.rest_id = $1;';
